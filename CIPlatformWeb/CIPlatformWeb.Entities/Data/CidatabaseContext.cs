...
public partial class CidatabaseContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
       //=> optionsBuilder.UseSqlServer("Server=PCI156\\SQLSERVER2017;Database=CIDATABASE;Persist Security Info=False;User ID=sa;Password=Tatva@123;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=30;");
        => optionsBuilder.UseSqlServer("Server=FRIDAY;Database=CIDATABASE;Trusted_Connection=True;TrustServerCertificate=True;Encrypt=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83F41D30BAF");
